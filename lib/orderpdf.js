...
async function findClientInfo(clientId) {
  const empty = { name: '', phone: '', address: '', suite: '', city: '', zip: '' };
...
function renderClientSection(doc, order, includeContact) {
  ...
  if (clean(order.ClientID)) lines.push('Client ID: ' + clean(order.ClientID));
  ...
  try {
    ...
    const buffer = buildCompletionPdf(Object.assign({}, data, {
      order: Object.assign({}, order, {
        ClientPhone: clientInfo.phone, ClientContactName: clientInfo.name,
